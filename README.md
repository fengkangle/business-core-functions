...
- Website URL: `[add your AtSpace website URL here]`
...
## Citation Statement for Assignment Document

You can cite this GitHub repository in the Word document like this:

```text
Reference #1
Title: Process Order Payment Source Code
Owner: Group 26, NIT3114 Online Business System Development
URL: [add GitHub URL to payment-core.php]

Reference #2
Title: Track Order Source Code
Owner: Group 26, NIT3114 Online Business System Development
URL: [add GitHub URL to tracking-core.php]

Reference #3
Title: Request Return and Refund Source Code
Owner: Group 26, NIT3114 Online Business System Development
URL: [add GitHub URL to refund-core.php]
```
...
6. Upload these files:
   ...
   - `refund-core.php`
7. Commit the upload.
8. Copy each file URL and paste it into the Assignment 2 Word document references.

### Option B: Use Git Commands

Run the following commands in the folder containing these four files:

```bash
git init
git add README.md payment-core.php tracking-core.php refund-core.php
git commit -m "Add core business function references"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/business-core-functions.git
...
In the Assignment 2 Word document, include:

- The AtSpace business site URL
- The three GitHub source-code reference URLs
- The owner name: Group 26 / Feng Kangle / Zhang Xinshun
- The page title or repository title for each reference